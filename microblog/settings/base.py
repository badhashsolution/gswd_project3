...
ADMINS = (
    ...
    ('badhash', 'badhashsolution@gmail.com')
)
...
ALLOWED_HOSTS = ['http://serene-hollows-8697.herokuapp.com/']
...
STATICFILES_DIRS = (
    ...
    # WGG note that we've changed this with our lambda script at the top
    root("assets"),
)
